...
- Dar y recibir retroalimentación constructiva con madurez.
...
- Comentarios despectivos, insultos personales o ataques políticos/religiosos (trolling).
- El acoso público o privado en cualquier canal (GitHub, Discord, chat del juego).
- Publicar información privada de otros, como direcciones físicas o electrónicas, sin su permiso explícito (doxxing).
- Cualquier otra conducta que razonablemente pueda considerarse inapropiada en un entorno profesional o comunitario.

---

## Aplicación y Responsabilidades

Los líderes del proyecto son responsables de aclarar y hacer cumplir nuestros estándares de comportamiento aceptable y tomarán las medidas correctivas apropiadas y justas en respuesta a cualquier comportamiento que consideren inapropiado, amenazante, ofensivo o dañino.

Los líderes del proyecto tienen el derecho y la responsabilidad de eliminar, editar o rechazar comentarios, commits, código, ediciones de wiki, issues y otras contribuciones que no estén alineadas con este Código de Conducta, y comunicarán las razones de las decisiones de moderación cuando sea apropiado.

---

## Alcance

Este Código de Conducta se aplica a todos los espacios del proyecto (repositorio en GitHub, canales de chat, servidores de Discord de la hermandad/comunidad), y también se aplica cuando un individuo representa oficialmente al proyecto en espacios públicos.
